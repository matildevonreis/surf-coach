...
| `/plan-week` | Plans the full training week. Fetches surf forecast, maps availability constraints, assigns gym session type per slot, generates complete schedule. Saves to `private/data/plans/YYYY-WNN.md` |
...
7. `/plan-week` — plan the first training week
